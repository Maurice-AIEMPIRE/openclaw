...
// Scale concurrency with available CPU cores: 2 on single-core, up to 8 on 8+ core machines.
const EMBEDDING_INDEX_CONCURRENCY = Math.min(8, Math.max(2, os.cpus().length));
const EMBEDDING_RETRY_MAX_ATTEMPTS = 3;
const EMBEDDING_RETRY_BASE_DELAY_MS = 500;
const EMBEDDING_RETRY_MAX_DELAY_MS = 8000;
const BATCH_FAILURE_LIMIT = 2;
const SESSION_DELTA_READ_CHUNK_BYTES = 128 * 1024;
